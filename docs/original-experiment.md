...
## Key Result: Immediate 100% ASR

The adversary achieved **100% attack success rate in round 0** -- before any training occurred. The base Llama-3.2-1B-Instruct model, given a red-teaming system prompt, immediately generated prompts that jailbroke the 3B victim on every attempt.
...
- The 3B victim's safety alignment was too weak for this attack category
